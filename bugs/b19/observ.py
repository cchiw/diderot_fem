...
target ="observ"
namenrrd = name+'.nrrd'
expf0 = (("0+(-4*1)+(-1*x[1])+(1*x[0]*x[1])+(-5*x[0])","0+(-1*1)+(2*x[1])+(-2*x[0]*x[1])+(2*x[0])"),("0+(-1*1)+(4*x[1])+(1*x[0]*x[1])+(5*x[0])","0+(-5*1)+(-4*x[1])+(2*x[0]*x[1])+(-2*x[0])"))
V= TensorFunctionSpace(UnitSquareMesh(4,4),"P",degree=2, shape =(2,2))

f0 = Function(V).interpolate(Expression(expf0))
expf1 = ("0+(1*x[1])+(1*x[0]*x[1])+(-2*x[0])","0+(5*1)+(1*x[1])+(4*x[0])")
V= VectorFunctionSpace(UnitSquareMesh(4,4),"P",degree=2, dim=2)
