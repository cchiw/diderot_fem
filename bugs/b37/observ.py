...
target ="ex1"
namenrrd = name+'.nrrd'
expf0 = "0+(5*x[1])+(2*x[0]*x[1])+(1*x[0])+(5*1*x[2])+(-5*x[1]*x[2])+(3*x[0]*x[1]*x[2])+(-2*x[0]*x[2])+(1*1*x[2]*x[2])+(2*x[1]*x[2]*x[2])+(1*x[0]*x[1]*x[2]*x[2])+(4*x[0]*x[2]*x[2])"
V= FunctionSpace(UnitCubeMesh(4,4,4),"P",degree=4)

f0 = Function(V).interpolate(Expression(expf0))
expf1 = ("0+(-3*1)+(3*x[1])+(-1*x[0]*x[1])+(-4*x[0])+(4*1*x[2])+(-1*x[1]*x[2])+(-4*x[0]*x[1]*x[2])+(2*x[0]*x[2])+(3*1*x[2]*x[2])+(-2*x[1]*x[2]*x[2])+(4*x[0]*x[1]*x[2]*x[2])+(-4*x[0]*x[2]*x[2])","0+(-2*1)+(5*x[1])+(-3*x[0]*x[1])+(3*x[0])+(-3*x[1]*x[2])+(-2*x[0]*x[2])+(2*1*x[2]*x[2])+(-4*x[1]*x[2]*x[2])+(-4*x[0]*x[1]*x[2]*x[2])+(1*x[0]*x[2]*x[2])","0+(1*1)+(2*x[1])+(-3*x[0]*x[1])+(-4*x[0])+(5*1*x[2])+(3*x[1]*x[2])+(5*x[0]*x[1]*x[2])+(3*x[0]*x[2])+(4*1*x[2]*x[2])+(-4*x[1]*x[2]*x[2])+(-5*x[0]*x[1]*x[2]*x[2])+(4*x[0]*x[2]*x[2])")
