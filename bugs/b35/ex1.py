...
target ="ex1"
namenrrd = name+'.nrrd'
expf0 = "0+(-2*1)+(5*x[1])+(-4*x[0]*x[1])+(4*x[0])+(1*x[1]*x[1])+(-1*x[1]*x[1]*x[0])+(4*x[0]*x[0]*x[1]*x[1])+(-4*x[0]*x[0]*x[1])+(2*x[0]*x[0])+(2*1*x[2])+(3*x[1]*x[2])+(2*x[0]*x[1]*x[2])+(-5*x[0]*x[2])+(1*x[1]*x[1]*x[2])+(4*x[1]*x[1]*x[0]*x[2])+(4*x[0]*x[0]*x[1]*x[1]*x[2])+(-1*x[0]*x[0]*x[1]*x[2])+(5*x[0]*x[0]*x[2])+(3*1*x[2]*x[2])+(3*x[1]*x[2]*x[2])+(3*x[0]*x[1]*x[2]*x[2])+(4*x[0]*x[2]*x[2])+(-4*x[1]*x[1]*x[2]*x[2])+(2*x[1]*x[1]*x[0]*x[2]*x[2])+(-4*x[0]*x[0]*x[1]*x[1]*x[2]*x[2])+(-3*x[0]*x[0]*x[1]*x[2]*x[2])"
