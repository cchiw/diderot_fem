...
target ="observ"
namenrrd = name+'.nrrd'
expf0 = "0+(1*1)+(-3*x[0])+(-5*x[1]*x[1])+(2*x[1]*x[1]*x[0])+(5*x[0]*x[0]*x[1]*x[1])+(5*x[0]*x[0]*x[1])+(-4*x[0]*x[0])"
V= FunctionSpace(UnitSquareMesh(4,4),"P",degree=4)

f0 = Function(V).interpolate(Expression(expf0))
expf1 = "0+(3*1)+(-4*x[1])+(1*x[0]*x[1])+(-3*x[0])+(3*x[1]*x[1])+(5*x[1]*x[1]*x[0])+(-1*x[0]*x[0]*x[1]*x[1])+(2*x[0]*x[0]*x[1])+(1*x[0]*x[0])"
