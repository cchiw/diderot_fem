 ...
 *
 * Command: /home/teodoro/gitcode/again/femprime/bin/diderotc --namespace=mesh_d2s_single --target=pthread --debug --namespace=mesh_d2s_single mesh_d2s_single.diderot
...
void mesh_d2s_single_set_num_workers (mesh_d2s_single_world_t *wrld, uint32_t nw)
{
    mesh_d2s_single::world *w = reinterpret_cast<mesh_d2s_single::world *>(wrld);
    if (nw == 0)
